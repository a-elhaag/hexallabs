---
name: hexal-sse-contract
description: Locked SSE event schema for Hexal-LM streaming. Invoke when adding or modifying any SSE endpoint (Oracle, Council, Relay, Workflow). All modes emit same event types so frontend has one consumer.
---
