---
name: hexal-whitelabel-names
description: Never leak real model names in Hexal-LM UI, API responses, logs visible to users, or error messages. Invoke when writing any user-facing string, API schema, or frontend component. Real names allowed ONLY on /about page.
---

# Hexal White-Label Names
