---
name: hexal-caching-rules
description: Prompt caching rules for Hexal-LM. Invoke when writing any prompt template for Apex synthesis, peer review, Council fan-out, or Prompt Forge. Claude uses explicit cache_control; Azure OpenAI uses automatic prefix cache.
---
