---
name: hexallabs-stack-constraints
description: Locked tech stack for HexalLabs. Invoke before adding ANY new dependency, changing package manager, or swapping a core tool. Prevents stack drift.
---

# HexalLabs Stack Constraints
