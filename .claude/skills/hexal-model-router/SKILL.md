---
name: hexal-model-router
description: Enforce Hexal-LM provider split — Apex/Pulse via direct Anthropic Console API, all others via Azure AI Foundry. Invoke when creating or editing any LLM client, factory, or model call site. Prevents mixing vendors or using wrong endpoint.
---
...
Hexal-LM uses **two providers**, no others:
